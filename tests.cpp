...
//   // 24 July 2015 04:15:00 AM
//   std::string cmd = std::string("date +") + '"' + std::string("%Y %m %d %r") + '"';
//   const char * cstr_cmd = cmd.c_str();
//   int tc = system(cstr_cmd);
//   if(ts != tc) {
//     std::cout << "[EEE] timestamp not equal" << tc << ", " << ts << std::endl;
//     return 2;
//   }
//   else {
//     std::cout << "[OK] timestamp" << std::endl;
//     return 0;
//   }
// }
